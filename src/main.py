...
from .window import RosettaWindow
...
class RosettaApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(
            application_id="page.codeberg.Rosetta.Rosetta",
        ...
        self.settings = Gio.Settings(schema_id="page.codeberg.Rosetta.Rosetta")
    ...
    def do_activate(self):
        ...
        if not self.win:
            self.win = RosettaWindow(application=self)
        self.win.present()
    ...
    def on_about_action(self, widget, _):
        ...
        about = Adw.AboutWindow(
            ...
            version=version,
            website="https://rosetta.codeberg.page",
            issue_url="https://github.com/Rosetta/Rosetta/issues",
            support_url="https://codeberg.org/Rosetta/Rosetta/issues",
